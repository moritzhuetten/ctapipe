...
class CameraCalibrator(Component):
    ...
    def _calibrate_dl1(self, event, telid, use_integration_correction):
    ...
    def __call__(self, event, use_integration_correction=True):
        """
        ...
        for telid in tel.keys():
            ...
            self._calibrate_dl1(event, telid, use_integration_correction)
